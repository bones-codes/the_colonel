...
special = ['RESERVED', 'ESC', 'BACKSPACE', 'ENTER', 
'CAPSLOCK', 'F1', 'F2', 'F3', 'F4', 'F5', 'F6', 
'F7', 'F8', 'F9', 'F10', 'NUMLOCK', 'SCROLLLOCK', 'F11','F12', 
'SYSRQ', 'LINEFEED', 'UP', 'PAGEUP', 'LEFT', 'RIGHT', 'END', 'KPENTER',
'DOWN', 'PAGEDOWN', 'INSERT', 'DELETE', 'MACRO', 'MUTE', 'VOLUMEDOWN', 
'VOLUMEUP', 'POWER', 'PAUSE', 'SCALE', 'HANGEUL', 
...
'COFFEE', 'SCREENLOCK', 'DIRECTION', 'CYCLEWINDOWS', 'MAIL', 'BOOKMARKS', 
'COMPUTER', 'BACK', 'FORWARD', 'CLOSECD', 'EJECTCD', 'EJECTCLOSECD', 'HOME',
'NEXTSONG', 'PLAYPAUSE', 'PREVIOUSSONG', 'STOPCD', 'RECORD', 'REWIND', 
'PHONE', 'ISO', 'CONFIG', 'HOMEPAGE', 'REFRESH', 'EXIT', 'MOVE',
'EDIT', 'SCROLLUP', 'SCROLLDOWN', 'NEW', 'REDO', 'F13', 'F14', 'F15', 'F16', 
'F17', 'F18', 'F19', 'F20', 'F21', 'F22', 'F23', 'F24', 'PLAYCD', 'PAUSECD', 
...
'DOCUMENTS', 'BATTERY', 'BLUETOOTH', 'WLAN', 'UWB', 'UNKNOWN', 'VIDEO_NEXT', 
'VIDEO_PREV', 'BRIGHTNESS_CYCLE', 'BRIGHTNESS_ZERO', 'DISPLAY_OFF', 'WIMAX', 
'RFKILL']

sym = {'TAB': ' [TAB]	', 'RIGHTCTRL': '[CTRL]', 'LEFTCTRL': '[CTRL]', 
...
shift_sym = {'TAB': ' [TAB]	', 'RIGHTCTRL': '[CTRL]', 'LEFTCTRL': '[CTRL]', 
...
for s in shift_keymap:
	if s == shift_keymap[len(shift_keymap)-1]:
		last = "'[" + s + "]']"
		f.write(last)
		break
	elif s in special:
